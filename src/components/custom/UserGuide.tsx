  ...
  <Dialog open={open} onOpenChange={onOpenChange}>
    <DialogContent className="max-w-[400px] rounded-md">
      ...
      <div className="grid gap-4 py-4">
        ...
        <p>3. View your search history by clicking the menu icon in the top right.</p>
        <p>4. Customize your API key and prompts in the settings page.</p>
        <p>5. Access this guide anytime by clicking the help icon in the history drawer.</p>
      </div>
